...
# Data set: Customer Comments in correlation with Clothing E-commerce reviewing 
import pandas as pd
import numpy as np 
...
# import data
df=pd.read_csv('/home/jihedder/Desktop/C_M_P/data.csv')
#df.isnull().sum()
df=df.fillna({'Title':'none'})
# Review Text : is the column which contains all the customer comments
...
# the mean scores is equivalent to 0.9577683305004624
